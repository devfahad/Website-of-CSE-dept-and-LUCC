        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="commentBox bg_ash">
                    ...
                    <?php 
                            $query = "select * from  tbl_blog_comment WHERE post_id='$id' AND status='Approved' order by id desc";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($name == "" || $email == "" || $phone == "" || $message == "" ) {
        ...
        $query = "INSERT INTO tbl_blog_comment(post_id, name, email, phone, message, status) VALUES('$postid', '$name', '$email', '$phone', '$message', '$status') ";
