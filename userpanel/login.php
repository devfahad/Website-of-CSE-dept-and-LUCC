...
$query = "SELECT * FROM tbl_user WHERE  password = '$password' And status = 'Approved'";
$result = $db->select($query);
 if ($result != false) {
    ...
    echo "<span style='color:red; font-size:18px;'>Email and password not matched..!! OR you are not apporved by admin. please contact us.</span>";
} 
